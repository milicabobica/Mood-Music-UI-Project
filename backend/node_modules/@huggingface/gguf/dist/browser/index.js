...
// src/types.ts
var _tasks = require('@huggingface/tasks');
...
var GGUF_QUANT_DESCRIPTIONS = {
  [_tasks.GGMLQuantizationType.F32]: {
  ...
  [_tasks.GGMLQuantizationType.F16]: {
  ...
  [_tasks.GGMLQuantizationType.Q8_0]: {
  ...
  [_tasks.GGMLQuantizationType.Q8_1]: {
  ...
  [_tasks.GGMLQuantizationType.Q8_K]: {
  ...
  [_tasks.GGMLQuantizationType.Q6_K]: {
  ...
  [_tasks.GGMLQuantizationType.Q5_0]: {
  ...
  [_tasks.GGMLQuantizationType.Q5_1]: {
  ...
  [_tasks.GGMLQuantizationType.Q5_K]: {
  ...
  [_tasks.GGMLQuantizationType.Q4_0]: {
  ...
  [_tasks.GGMLQuantizationType.Q4_1]: {
  ...
  [_tasks.GGMLQuantizationType.Q4_K]: {
  ...
  [_tasks.GGMLQuantizationType.Q3_K]: {
  ...
  [_tasks.GGMLQuantizationType.Q2_K]: {
  ...
  [_tasks.GGMLQuantizationType.IQ4_XS]: {
  ...
  [_tasks.GGMLQuantizationType.IQ3_S]: {
  ...
  [_tasks.GGMLQuantizationType.IQ3_XXS]: {
  ...
  [_tasks.GGMLQuantizationType.IQ2_S]: {
  ...
  [_tasks.GGMLQuantizationType.IQ2_XS]: {
  ...
  [_tasks.GGMLQuantizationType.IQ2_XXS]: {
  ...
  [_tasks.GGMLQuantizationType.IQ1_S]: {
  ...
  [_tasks.GGMLQuantizationType.IQ4_NL]: {
  ...
  [_tasks.GGMLQuantizationType.IQ1_M]: {
  ...
  [_tasks.GGMLQuantizationType.BF16]: {
  ...
  [_tasks.GGMLQuantizationType.TQ1_0]: {
    txt: "Ternary quantization.",
    src_url: "https://github.com/ggml-org/llama.cpp/pull/8151"
  },
  [_tasks.GGMLQuantizationType.TQ2_0]: {
    txt: "Ternary quantization.",
    src_url: "https://github.com/ggml-org/llama.cpp/pull/8151"
  },
  [_tasks.GGMLQuantizationType.MXFP4]: {
...
var GGML_QUANT_SIZES = {
  [_tasks.GGMLQuantizationType.F32]: calcBPW(1, 4),
  [_tasks.GGMLQuantizationType.F16]: calcBPW(1, 2),
  [_tasks.GGMLQuantizationType.Q4_0]: calcBPW(32, 2 + 16),
  [_tasks.GGMLQuantizationType.Q4_1]: calcBPW(32, 2 + 2 + 16),
  [_tasks.GGMLQuantizationType.Q5_0]: calcBPW(32, 2 + 4 + 16),
  [_tasks.GGMLQuantizationType.Q5_1]: calcBPW(32, 2 + 2 + 4 + 16),
  [_tasks.GGMLQuantizationType.Q8_0]: calcBPW(32, 2 + 32),
  [_tasks.GGMLQuantizationType.Q8_1]: calcBPW(32, 4 + 4 + 32),
  [_tasks.GGMLQuantizationType.Q2_K]: calcBPW(256, 2 + 2 + QK_K / 16 + QK_K / 4),
  [_tasks.GGMLQuantizationType.Q3_K]: calcBPW(256, 2 + QK_K / 4 + QK_K / 8 + 12),
  [_tasks.GGMLQuantizationType.Q4_K]: calcBPW(256, 2 + 2 + QK_K / 2 + 12),
  [_tasks.GGMLQuantizationType.Q5_K]: calcBPW(256, 2 + 2 + QK_K / 2 + QK_K / 8 + 12),
  [_tasks.GGMLQuantizationType.Q6_K]: calcBPW(256, 2 + QK_K / 2 + QK_K / 4 + QK_K / 16),
  [_tasks.GGMLQuantizationType.Q8_K]: calcBPW(256, 4 + QK_K + QK_K / 8),
  [_tasks.GGMLQuantizationType.IQ2_XXS]: calcBPW(256, 2 + QK_K / 4),
  [_tasks.GGMLQuantizationType.IQ2_XS]: calcBPW(256, 2 + QK_K / 4 + QK_K / 32),
  [_tasks.GGMLQuantizationType.IQ3_XXS]: calcBPW(256, 2 + QK_K / 4 + QK_K / 8),
  [_tasks.GGMLQuantizationType.IQ1_S]: calcBPW(256, 2 + QK_K / 8 + QK_K / 16),
  [_tasks.GGMLQuantizationType.IQ4_NL]: calcBPW(32, 2 + 16),
  [_tasks.GGMLQuantizationType.IQ3_S]: calcBPW(256, 2 + QK_K / 4 + QK_K / 8 + QK_K / 32 + 4),
  [_tasks.GGMLQuantizationType.IQ2_S]: calcBPW(256, 2 + QK_K / 4 + QK_K / 16),
  [_tasks.GGMLQuantizationType.IQ4_XS]: calcBPW(256, 2 + 2 + QK_K / 2 + QK_K / 64),
  [_tasks.GGMLQuantizationType.I8]: calcBPW(1, 1),
  [_tasks.GGMLQuantizationType.I16]: calcBPW(1, 2),
  [_tasks.GGMLQuantizationType.I32]: calcBPW(1, 4),
  [_tasks.GGMLQuantizationType.I64]: calcBPW(1, 8),
  [_tasks.GGMLQuantizationType.F64]: calcBPW(1, 8),
  [_tasks.GGMLQuantizationType.IQ1_M]: calcBPW(256, QK_K / 8 + QK_K / 16 + QK_K / 32),
  [_tasks.GGMLQuantizationType.BF16]: calcBPW(1, 2),
  [_tasks.GGMLQuantizationType.TQ1_0]: calcBPW(256, 2 + 4 * 13),
  [_tasks.GGMLQuantizationType.TQ2_0]: calcBPW(256, 2 + 64),
  [_tasks.GGMLQuantizationType.MXFP4]: calcBPW(32, 1 + 16)
};
...
function serializeGgufMetadata(typedMetadata, options = {}) {
  ...
  const alignment = (_b = options.alignment) != null ? _b : 32;
...
exports.GGMLFileQuantizationType = _tasks.GGMLFileQuantizationType; exports.GGMLQuantizationType = _tasks.GGMLQuantizationType; exports.GGUFValueType = GGUFValueType; exports.GGUF_QUANT_DESCRIPTIONS = GGUF_QUANT_DESCRIPTIONS; exports.GGUF_QUANT_ORDER = _tasks.GGUF_QUANT_ORDER; exports.GGUF_QUANT_RE = _tasks.GGUF_QUANT_RE; exports.GGUF_QUANT_RE_GLOBAL = _tasks.GGUF_QUANT_RE_GLOBAL; exports.RE_GGUF_FILE = RE_GGUF_FILE; exports.RE_GGUF_SHARD_FILE = RE_GGUF_SHARD_FILE; exports.findNearestQuantType = _tasks.findNearestQuantType; exports.gguf = gguf; exports.ggufAllShards = ggufAllShards; exports.parseGGUFQuantLabel = _tasks.parseGGUFQuantLabel; exports.parseGgufShardFilename = parseGgufShardFilename; exports.serializeGgufMetadata = serializeGgufMetadata;
